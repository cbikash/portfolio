...
const ScrollToBottomButton = () => {
    ...
    return (
        <>
            <button
                onClick={scrollToTop}
                className={`fixed bottom-23 right-7  p-1 bg-blue-500  text-white rounded-full shadow-lg transition-all ${
            ...
            <div className={'fixed bottom-4 right-4'}>
                <a className="whatsapp-button" target="_blank"
                   href="https://api.whatsapp.com/send/?phone=9779845969704&amp;text&amp;type=phone_number&amp;app_absent=0">
